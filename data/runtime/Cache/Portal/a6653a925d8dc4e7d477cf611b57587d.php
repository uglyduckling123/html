...
<body>
  <div class="content">
    ...
    <div class="main">
      <div class="main_top">
        <p class="main_nav"><a href="/index.php"style=" ">首页</a>>>定州市公众信息网  >> 其他</p>
      </div>
        ...
        <div class="list_content" style="height: 300px">
          <table border="0" cellspacing="0" cellspacing="0" >
             <tr><th width="800" height="500" class="list_l">名&nbsp;&nbsp;称</th><th width="180">发布日期</th></tr>
              <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr><td><a href="<?php echo U('Index/detailInfo',array('id'=>$vo[id],'post_author'=>$vo[post_author],'post_category'=>$vo[post_category]));?>"><?php echo ($vo["post_title"]); ?></a></td><td><?php echo ($vo["post_date"]); ?></td></tr><?php endforeach; endif; ?>
          </table>
          <!-- 分页 start-->
