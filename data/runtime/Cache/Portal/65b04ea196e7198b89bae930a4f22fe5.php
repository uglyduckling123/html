		...
		<form class="J_ajaxForm" action="" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td><!--<?php echo ($excerpt_keywords = empty($vo['post_keywords'])?"":'已填写'); ?>--><?php echo ($vo['post_keywords']); ?></td>
					<td><!--<?php echo ($excerpt_source = empty($vo['post_source'])?" ":'已填写'); ?>--><?php echo ($vo['post_source']); ?></td>
