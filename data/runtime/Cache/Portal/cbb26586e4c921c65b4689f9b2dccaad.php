  ...
  <div class="content">
    ...
    <div class="main">
      ...
      <div class="main_bottom">
        <div class="article_content article_bg">
          <?php if($data[post_category] == $post_category_bugget): ?><h4 class="article_title">定州市部门预算</h4>
            <?php else: ?>
            <h4 class="article_title">定州市部门决算</h4><?php endif; ?>
          <div class="news_date">发布日期：<?php echo ($data["post_modified"]); ?></div>
          <div class="news_text"><?php echo ($data["post_content"]); ?></div>
         <!-- <div class="news_flip">
            <div class="nf_left">
              <span>上一篇：</span><a href="">没有文章</a><br />
              <span>下一篇：</span><a href="">预决算公开管理文件</a>
            </div>
            <p class="nf_right">本文已经阅读19次</p>
          </div>-->
        </div>
      </div>
